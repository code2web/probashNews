...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
  <form method="post" id="updatedistrictForm">
    @csrf
    @method('PUT')
      ...
      <div class="modal-content ml-5">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="up_name">district Name</label>
            <input type="text" class="form-control" id="up_name" name="up_name">
          </div>          
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary update_district">Update district</button>
        </div>
      </div>
    </div>
  </form>

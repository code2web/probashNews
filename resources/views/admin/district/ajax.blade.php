...
$(document).ready(function(){
  $(document).on('click', '.create_district', function(e){
    e.preventDefault();
    let name = $('#name').val();
    // console.log(name);
    $.ajax({
  ...
  $(document).on('click', '.delete_district', function(e){
    ...
    if (confirm('Are you sure to Delete')) {
      $.ajax({
        url: "{{route('district.destroy',$district->id)}}",
        method: "delete",
  ...
  function pagination(page){
    $.ajax({
      // url:"/admin/pagination/district?page="+page,
      url:"{{route('pagination_district')}}?page="+page,      
      success:function(res){
        $('.card-body').html(res);
      }
    })

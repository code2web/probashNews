	...
	<section class="gcontainer top CategoryPage SinglePage">
		...
		<div>
			<div class="SingleMain">
				...
				<p>আপডেট: {{$article->updated_at->format('H:i ঘণ্টা, M d, Y') }}</p>
				@endif
				{{-- <p>আপডেট: ২০১৫ ঘণ্টা, ফেব্রুয়ারি ২৪, ২০২৪</p> --}}
				<br><br>			
				<div class="imgDiv"><img src="img/common-pic.png" data-src="{{$article->thumbnail}}" alt=""></div>
				<br>
				<p>
					<strong>{{$article->district->name}}:</strong>
					{{-- {{$article->content}} --}}
					{!! $article->content !!}
				</p>
				<br>
				<p>বাংলাদেশ সময়: {{$article->created_at->format('H:i ঘণ্টা, M d, Y') }}</p>
				<p>আরএ</p>
				<br>
				<b class="moreRead">ক্লিক করুন, আরো পড়ুন <i class="fa fa-arrow-right"></i></b>
				@if ($article->tags()->count() > 0)
				@foreach ($article->tags as $tag)
				<button class="btn moreReadBtn">সড়ক দুর্ঘটনা {{$tag->name}}</button><br><br>
				@endforeach
				@endif
...
<div class="mobile">
	<div class="SingleMain">
		<h1>রাজবাড়ীতে বাসের ধাক্কায় শ্বশুর-পুত্রবধূ নিহত = Single Page DETAILS</h1>	
		<p>ডিস্ট্রিক্ট করেসপন্ডেন্ট | বাংলানিউজটোয়েন্টিফোর.কম</p>
		<p>আপডেট: ২০১৫ ঘণ্টা, ফেব্রুয়ারি ২৪, ২০২৪</p>
		<br><br>			
		<div class="imgDiv"><img src="img/all.jpg" onerror="this.onerror=null; if (this.src != 'img/default.jpg') this.src = 'img/default.jpg';" alt=""></div>
	...
	<div class="boxTitle singleMobileHead">
		<h5><a href="">এই বিভাগের সর্বশেষ সংবাদ</a></h5>
	</div>	
	<div class="clear"></div>
	...
	<br>
	<div class="boxTitle singleMobileHead">
		<h5><a href="">আজকের সর্বশেষ খবর</a></h5>
	</div>	
	<div class="clear"></div>
